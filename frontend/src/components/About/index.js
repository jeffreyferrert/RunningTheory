  ...
  return (
    ...
    <div id='about-main-container'>
      ...
      <div id='team-container'>
        <div id='one'><img alt="img" className='team-img' src='/comp-emoji.png' /><div className='position'>Backend Lead</div>
          <div className="links-auth">
            ...
            {menu1 ? <>
              <div id='both-cont' onMouseEnter={open1} onMouseLeave={close1}> <div id='main-drop-cont-signin'> <div id='user-all-container-signin'>
                <div id='all-tracker'>
                  <button id='all-tracks-signin' className='button-link' >
                    Jeffrey Ferrer
                  </button>
                </div>
              </div>
              ...
              <div id='all-tracker'>
                <button id='all-tracks-signin' className='button-link' to={'/tracks'}>
                  Jeffrey Ferrer
                </button>
              </div> </div> </div>  </div>}
          </div></div>

        <div id='two'><img alt="img" className='team-img' src='/comp-emoji.png' /><div className='position'>The Lead</div>
          <div className="links-auth">
              ...
              <div id='both-cont' onMouseEnter={open2} onMouseLeave={close2}> <div id='main-drop-cont-signin'> <div id='user-all-container-signin'>
                ...
                <div id='extender-container-signin'>
                  <div id='icons'>
                    ...
                    <div id='linked' className='symbol'> <a href='https://www.linkedin.com/in/jason-staubach-80313a22b/'><i className="fa-brands fa-linkedin fa-2xl" style={{ fontSize: '3em', color: "#0a66c2" }}></i></a></div>
                  </div>
                </div>
              </div>
            </> : <div id='both-cont' onMouseEnter={open2} onMouseLeave={close2}> <div id='main-drop-cont-signin' > <div id='user-all-container-signin'>
        ...
        <div id='three'><img alt="img" className='team-img' src='/comp-emoji.png' /><div className='position'>Frontend Lead</div>
          <div className="links-auth">
        ...
        <div id='four'><img alt="img" className='team-img' src='/comp-emoji.png' /><div className='position'>Flex Lead</div>
          <div className="links-auth">
